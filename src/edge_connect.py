...
class EdgeConnect():
    def __init__(self, config):
        ...
        self.model_path = os.path.join(config.PATH, 'models')
        ...
        while(keep_training):
            ...
            for items in train_loader:
                ...
                # joint model
                    ...
                    # backward
                    self.inpaint_model.backward(i_gen_loss, i_dis_loss, i_gen_landmark_loss, retain_graph=True)
    ...
    def test(self):
        ...
        for items in test_loader:
            ...
            # inpaint with edge model / joint model
                ...
                edges, _ = self.edge_model(images_gray, edges, masks)
                edges = edges.detach()
                outputs, _ = self.inpaint_model(images, edges, masks)
                outputs_merged = (outputs * masks) + (images * (1 - masks))
    ...
    def sample(self, it=None):
        ...
        if model == 1:
            ...
            outputs_merged = (outputs * masks) + (edges * (1 - masks))
            outputs_landmarks = images.clone()
